...
builder.add_node("google_research_assistant", google_research_assistant)
...
builder.add_edge("image_question", "google_research_assistant")
builder.add_edge("image_question", "disposal_guide")
builder.add_edge("tavily_research_assistant", "generate_answer")
builder.add_edge("google_research_assistant", "generate_answer")
